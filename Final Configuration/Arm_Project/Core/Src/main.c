...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, STEP_Pin|DIR_Pin|ENA_Pin|NRF_CSN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : STEPPER_LIMIT_Pin */
  GPIO_InitStruct.Pin = STEPPER_LIMIT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(STEPPER_LIMIT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : GRIPPER_LIMIT_Pin */
