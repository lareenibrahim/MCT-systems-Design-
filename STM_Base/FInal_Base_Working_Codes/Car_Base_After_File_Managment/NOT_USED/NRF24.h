...
/*
 * Robust cold start — call this on every boot instead of nrf24_init()
 * Handles dirty register state from previous session, USB unplug, power loss
 * Returns 1 if OK, 0 if SPI failed
 */
uint8_t nrf24_cold_start(void);
